...
- (void)queryDeviceLabelResponse:(NSDictionary *)dict deviceMac:(NSString *)dviceMac{
    ...
    NSArray * tagsArray = [dict[@"label"] componentsSeparatedByString:@"|"];//以“,”切割
    NSString *json = [ToolHandle toJsonString:tagsArray];
    NSString *jsonCode = [NSString stringWithFormat:@"deviceLabelResponse('%@','%@','%@')",dviceMac,json,dict[@"result"]];
    [self.web evaluateJavaScript:jsonCode completionHandler:^(id _Nullable web, NSError * _Nullable error) {
...
- (void)settingDeviceLabelResponse:(NSDictionary *)dict deviceMac:(NSString *)dviceMac{
    ...
    NSArray * tagsArray = [dict[@"label"] componentsSeparatedByString:@"|"];//以“,”切割
    NSString *json = [ToolHandle toJsonString:tagsArray];
    NSString *jsonCode = [NSString stringWithFormat:@"setDeviceLabelResponse('%@','%@','%@')",dviceMac,json,dict[@"result"]];
    [self.web evaluateJavaScript:jsonCode completionHandler:^(id _Nullable web, NSError * _Nullable error) {
